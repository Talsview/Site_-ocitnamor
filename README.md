...
- **Botão NÃO 😏**: teste passar o mouse por cima (desktop), tocar nele
  (celular) e também navegar até ele pelo teclado (Tab) — em todos os casos
  ele deve "fugir" para outro ponto da tela, sem nunca ser possível
  confirmar um "não". Redimensione a janela ou gire o celular para conferir
  que ele nunca sai da área visível.
